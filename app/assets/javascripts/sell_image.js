$(function () {
  ...
  var dropzone = $('.sell-main__image__title__photos-box__select-area1');
  var dropzone2 = $('.sell-main__image__title__photos-box__select-area2');
  var dropzone_box = $('.select-image-area');
  var images = [];
  var inputs  =[];
  ...
  $(document).on('change', 'input[type= "file"].upload-image',function(event) {
    ...
    inputs.push($(this));
    var img = $(`<div class= "img_view"><img width="150" height="150"></div>`);
