  ...
  $(document).ready(function(){
    $(window).load(function(){
      ...
      $(document).on('click', '.image_upload', function(){
        ...
        var preview = $('<div class="image-preview__wapper"><img class="preview" style="height:150px"></div><div class="image-preview__btn"><div class="image-preview__btn__edit">編集</div><div class="image-preview__btn__delete">削除</div></div>'); 
        //次の画像を読み込むためのinput。 
